            ...
            SizedBox(
              ...
              child: ListView(
                ...
                children: const [
                  ...
                  CircleAvatar(
                    radius: 30,
                    backgroundImage: AssetImage('assets/avatars/user2.png'),
                  ),
                  SizedBox(width: 12),
                  CircleAvatar(
                    radius: 30,
                    backgroundImage: AssetImage('assets/avatars/user3.png'),
                  ),
                  SizedBox(width: 12),
                  CircleAvatar(
                    radius: 30,
                    backgroundImage: AssetImage('assets/avatars/user4.png'),
                  ),
                  SizedBox(width: 12),
                  CircleAvatar(
                    radius: 30,
                    backgroundImage: AssetImage('assets/avatars/user5.png'),
                  ),
                ],
              ),
            ),
